...
class ReactionConditions(_message.Message):
    __slots__ = ("temperature", "pressure", "stirring", "illumination", "electrochemistry", "mechanochemistry", "flow", "reflux", "ph", "conditions_are_dynamic", "details")
